...
#define MAKE_UTF8(c) \
    (char) (c < 0x80 ? c : c < 0x800 ? 192 + (c / 64) : c - 0xd800u < 0x800 ? '?' : c < 0x10000 ? 224 + (c / 4096) : c < 0x110000 ? 240 + (c / 262144) : '?'), \
    (char) (c < 0x80 ? 0 : c < 0x800 ? 128 + (c % 64) : c - 0xd800u < 0x800 ? '?' : c < 0x10000 ? 128 + (c / 64) % 64 : c < 0x110000 ? 128 + (c / 4096) % 64 : '?'), \
    (char) (c < 0x80 ? 0 : c < 0x800 ? 0 : c - 0xd800u < 0x800 ? '?' : c < 0x10000 ? 128 + (c % 64) : c < 0x110000 ? 128 + (c / 64) % 64 : '?'), \
    (char) (c < 0x80 ? 0 : c < 0x800 ? 0 : c - 0xd800u < 0x800 ? '?' : c < 0x10000 ? 0 : c < 0x110000 ? 128 + (c % 64) : '?'),

static const char charset_overrides[4][128][4] =
{
    [CCSET_BASIC_AMERICAN] = {
        [0x27] = { MAKE_UTF8(0x2019) },
        [0x2a] = { MAKE_UTF8(0x00e1) },
        [0x5c] = { MAKE_UTF8(0x00e9) },
        [0x5e] = { MAKE_UTF8(0x00ed) },
        [0x5f] = { MAKE_UTF8(0x00f3) },
        [0x60] = { MAKE_UTF8(0x00fa) },
        [0x7b] = { MAKE_UTF8(0x00e7) },
        [0x7c] = { MAKE_UTF8(0x00f7) },
        [0x7d] = { MAKE_UTF8(0x00d1) },
        [0x7e] = { MAKE_UTF8(0x00f1) },
        [0x7f] = { MAKE_UTF8(0x2588) },
    },
    [CCSET_SPECIAL_AMERICAN] = {
        [0x30] = { MAKE_UTF8(0x00ae) },
        [0x31] = { MAKE_UTF8(0x00b0) },
        [0x32] = { MAKE_UTF8(0x00bd) },
        [0x33] = { MAKE_UTF8(0x00bf) },
        [0x34] = { MAKE_UTF8(0x2122) },
        [0x35] = { MAKE_UTF8(0x00a2) },
        [0x36] = { MAKE_UTF8(0x00a3) },
        [0x37] = { MAKE_UTF8(0x266a) },
        [0x38] = { MAKE_UTF8(0x00e0) },
        [0x39] = { MAKE_UTF8(0x00A0) },
        [0x3a] = { MAKE_UTF8(0x00e8) },
        [0x3b] = { MAKE_UTF8(0x00e2) },
        [0x3c] = { MAKE_UTF8(0x00ea) },
        [0x3d] = { MAKE_UTF8(0x00ee) },
        [0x3e] = { MAKE_UTF8(0x00f4) },
        [0x3f] = { MAKE_UTF8(0x00fb) },
    },
    [CCSET_EXTENDED_SPANISH_FRENCH_MISC] = {
        [0x20] = { MAKE_UTF8(0x00c1) },
        [0x21] = { MAKE_UTF8(0x00c9) },
        [0x22] = { MAKE_UTF8(0x00d3) },
        [0x23] = { MAKE_UTF8(0x00da) },
        [0x24] = { MAKE_UTF8(0x00dc) },
        [0x25] = { MAKE_UTF8(0x00fc) },
        [0x26] = { MAKE_UTF8(0x00b4) },
        [0x27] = { MAKE_UTF8(0x00a1) },
        [0x28] = "*",
        [0x29] = { MAKE_UTF8(0x2018) },
        [0x2a] = "-",
        [0x2b] = { MAKE_UTF8(0x00a9) },
        [0x2c] = { MAKE_UTF8(0x2120) },
        [0x2d] = { MAKE_UTF8(0x00b7) },
        [0x2e] = { MAKE_UTF8(0x201c) },
        [0x2f] = { MAKE_UTF8(0x201d) },
        [0x30] = { MAKE_UTF8(0x00c0) },
        [0x31] = { MAKE_UTF8(0x00c2) },
        [0x32] = { MAKE_UTF8(0x00c7) },
        [0x33] = { MAKE_UTF8(0x00c8) },
        [0x34] = { MAKE_UTF8(0x00ca) },
        [0x35] = { MAKE_UTF8(0x00cb) },
        [0x36] = { MAKE_UTF8(0x00eb) },
        [0x37] = { MAKE_UTF8(0x00ce) },
        [0x38] = { MAKE_UTF8(0x00cf) },
        [0x39] = { MAKE_UTF8(0x00ef) },
        [0x3a] = { MAKE_UTF8(0x00d4) },
        [0x3b] = { MAKE_UTF8(0x00d9) },
        [0x3c] = { MAKE_UTF8(0x00f9) },
        [0x3d] = { MAKE_UTF8(0x00db) },
        [0x3e] = { MAKE_UTF8(0x00ab) },
        [0x3f] = { MAKE_UTF8(0x00bb) },
    },
    [CCSET_EXTENDED_PORTUGUESE_GERMAN_DANISH] = {
        [0x20] = { MAKE_UTF8(0x00c3) },
        [0x21] = { MAKE_UTF8(0x00e3) },
        [0x22] = { MAKE_UTF8(0x00cd) },
        [0x23] = { MAKE_UTF8(0x00cc) },
        [0x24] = { MAKE_UTF8(0x00ec) },
        [0x25] = { MAKE_UTF8(0x00d2) },
        [0x26] = { MAKE_UTF8(0x00f2) },
        [0x27] = { MAKE_UTF8(0x00d5) },
        [0x28] = { MAKE_UTF8(0x00f5) },
        [0x29] = "{",
        [0x2a] = "}",
        [0x2b] = "\\",
        [0x2c] = "^",
        ...
        [0x2e] = "|",
        [0x2f] = "~",
        [0x30] = { MAKE_UTF8(0x00c4) },
        [0x31] = { MAKE_UTF8(0x00e4) },
        [0x32] = { MAKE_UTF8(0x00d6) },
        [0x33] = { MAKE_UTF8(0x00f6) },
        [0x34] = { MAKE_UTF8(0x00df) },
        [0x35] = { MAKE_UTF8(0x00a5) },
        [0x36] = { MAKE_UTF8(0x00a4) },
        [0x37] = { MAKE_UTF8(0x00a6) },
        [0x38] = { MAKE_UTF8(0x00c5) },
        [0x39] = { MAKE_UTF8(0x00e5) },
        [0x3a] = { MAKE_UTF8(0x00d8) },
        [0x3b] = { MAKE_UTF8(0x00f8) },
        [0x3c] = { MAKE_UTF8(0x250c) },
        [0x3d] = { MAKE_UTF8(0x2510) },
        [0x3e] = { MAKE_UTF8(0x2514) },
        [0x3f] = { MAKE_UTF8(0x2518) },
    },
};
